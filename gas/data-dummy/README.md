...
| COLLAB_STEPS | 26 | Proses tiap task kolaborasi + PIC, deadline, catatan | — |
| NOTIFICATIONS | 9 | Notifikasi mention & giliran (ada yang belum dibaca) | — |
| ACTIVITY | 34 | Riwayat aktivitas — membuat tab Laporan berisi angka | — |
| LINKS | 13 | Link pribadi per user, berfolder | — |
| NOTES | 9 | Catatan pribadi per user, berfolder | — |
| DASHBOARDS | 3 | Tautan dashboard eksternal | — |
...
- **5 task overdue**, **2 jatuh tempo hari ini**, **7 jatuh tempo ≤3 hari**
- Semua status terpakai: Done (14) · In progress (13) · Todo (11) · Review PM (7) · Revisi (3) · Hold (2)
